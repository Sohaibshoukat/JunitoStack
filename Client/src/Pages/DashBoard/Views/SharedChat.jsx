        ...
        <div className='w-[90%] pb-20 m-auto'>
            <div className='grid grid-cols-1 my-10 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-8 w-[90%] lg:w-[80%] m-auto'>
                {sharedChats.map((item, index) => (
                    <div className={`flex flex-col justify-between group gap-3 font-para py-2 md:py-4 px-3 md:px-6 bg-white rounded-2xl shadow-shadow3 ease-in-out duration-300`} key={index}>
