    ...
    const Department = [
        {
            ...
            Icon: "../BotIcons/Bots/hr.png"
        },
        {
            Title: "Startup",
            Des: "Get to know more about Startup Prompts",
            Icon: "../BotIcons/Bots/startup.png"
        },
        {
            Title: "Vertrieb",
            Des: "Get to know more about Vertrieb Prompts",
            Icon: "../BotIcons/Bots/vertrieb.png"
        },
        {
            Title: "Support",
            Des: "Get to know more about Support Prompts",
            Icon: "../BotIcons/Bots/support.png"
        },
        {
            Title: "Marketing",
            Des: "Get to know more about Marketing Prompts",
            Icon: "../BotIcons/Bots/marketing.png"
        },
        {
            Title: "Assistenz",
            Des: "Get to know more about Assistenz Prompts",
