...
const TODOModel = ({ModelTODO,setModelTODO}) => {
  return (
    <>
            {ModelTODO &&
                    ...
                    <div className='bg-gray/50 rounded-2xl py-6 px-4 md:px-8 w-[90%] md:w-[80%] lg:w-[60%] xl:w-[50%] relative z-30 m-auto h-fit'>
                        ...
                        <div className="flex flex-col w-[80%] m-auto font-para gap-4">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <input type="date" className='bg-[#EDF2F6] rounded-lg border-none outline-none py-2 px-4' placeholder='Please Enter Full Name' />
                            </div>
                            <div className="flex flex-col gap-1">
                                <label htmlFor="" className='text-white'>SubUser</label>
                                <select name="" id="" className='bg-[#EDF2F6] rounded-lg border-none outline-none py-2 px-4'>
