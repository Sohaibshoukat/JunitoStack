...
const Features = () => {
    ...
    return (
        <div className='bg-gray w-[100%] py-10'>
            <div className="flex flex-col items-center gap-2 mb-8">
                <h1 className=' text-white text-base xl:text-lg font-medium font-para'>Become one of us!</h1>
                <h1 className=' text-white text-xl md:text-2xl lg:text-3xl font-extrabold font-para  mb-0 xl:mb-2'>Features</h1>
                <p
                    className=' text-white font-para text-sm md:text-base font-normal text-center max-w-[90%] lg:max-w-[60%]  mb-0 xl:mb-2'
                >
            ...
            <div className="lg:flex hidden flex-row gap-4 2xl:gap-8 w-[95%] 2xl:w-[90%] m-auto">
                {Data.map((item, index) => (
                    <div className="flex flex-row gap-2 basis-[33.33%]">
                ...
                >
                    {Data.map((item, index) => (
                        <SwiperSlide>
                            ...
                            <div className="flex flex-col gap-2 mb-5 basis-[33.33%]">
                                <div className="flex flex-row gap-2">
                                    <h1 className='text-[#EAEAEA] text-2xl font-bold font-para'>{index}</h1>
                                    <h2 className='text-white font-para font-bold text-lg'>{item.head}</h2>
                                </div>
                                <p className='text-white font-para text-sm'>{item.des}</p>
                            </div>
                        </SwiperSlide>
                    ))}
                </Swiper>
