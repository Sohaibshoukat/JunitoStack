                    ...
                    {ForgotFields.map((item, index) => (
                        <div className={`border-t-[30px] md:border-t-[40px] border-b-[20px] border-x-[20px] border-gray rounded-lg relative bg-gray  text-black h-full shadow-xl`}>
                            ...
                            <div className='rounded-3xl p-2 md:p-4 '>
                                ...
                                <input type="email" placeholder='example@mail.com' className={`py-3 px-4 rounded-lg w-full font-Para mb-4 text-base md:text-xl  border border-white text-white bg-black hover:bg-black hover:border-gray hover:text-white duration-300 ease-in-out  focus:border-gray `} />
